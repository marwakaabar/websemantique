...
//add new value
    ...
    public static void writeModel(Model model, String outputDataFile) {
        try (OutputStream out = new FileOutputStream(outputDataFile)) {
            model.write(out, "RDF/XML");
        } catch (IOException e) {
            System.out.println("Error writing model to file: " + e.getMessage());
        }
    }
